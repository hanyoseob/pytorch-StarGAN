...
parser.add_argument('--dir_result', default='./results_', dest='dir_result')
...
parser.add_argument('--wgt_rec', type=float, default=1e1, dest='wgt_rec')
parser.add_argument('--wgt_gp', type=float, default=1e1, dest='wgt_gp')
